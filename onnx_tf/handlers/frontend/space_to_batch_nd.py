...
class SpaceToBatchND(FrontendHandler):
  ...
  def version_9(cls, node, **kwargs):
    ...
    block_shape = kwargs['consts']['SpaceToBatchND/block_shape']
    input_paddings = kwargs['consts']['SpaceToBatchND/paddings']
    input_shape = kwargs['consts']['SpaceToBatchND/input'].shape

    m = block_shape.shape[0]
    n = kwargs['consts']['SpaceToBatchND/input'].ndim
